package com.fitnuz.project.Exception;
...
import com.fitnuz.project.Payload.Response.ApiResponse;
...
public class MyGlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> myDuplicateResourceFoundException(DuplicateResourceFoundException e){
        String message = e.getMessage();
        ApiResponse apiResponse = new ApiResponse(message,false);
    ...
    public ResponseEntity<ApiResponse> myGeneralAPIException(GeneralAPIException e){
        String message = e.getMessage();
        ApiResponse apiResponse = new ApiResponse(message,false);
        return new ResponseEntity<>(apiResponse,HttpStatus.NOT_FOUND);
    }
